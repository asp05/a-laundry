      ...
      <div class="row">
        <div class="col-md-9 col-xs-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="<?=base_url('setting/jenis_paket/tambah')?>">
                <div class="row">
                  <div class="col-md-12 col-xs-12">
                    <div class="form-group">
                      <label>Nama Jenis</label>
                        <input type="text" name="nama_jenis" placeholder="nama jenis.." class="form-control" value="<?=set_value('nama_jenis')?>">
                ...
                <div class="row">
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                      <label>Kiloan</label>
                        <input type="number" name="kiloan" onchange="nilaiwe(this.value)" onkeyup="nilaiwe(this.value)" onclick="nilaiwe(this.value)" placeholder="kiloan.." class="form-control" value="<?=set_value('kiloan')?>">
                  ...
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                      <label>Satuan</label>
                        <input type="number" name="satuan" onchange="nilais(this.value)" onkeyup="nilais(this.value)" onclick="nilais(this.value)" placeholder="satuan.." class="form-control" value="<?=set_value('satuan')?>">
                        <div style="margin-top: 0.2cm">
